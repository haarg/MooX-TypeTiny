...
This module optimizes L<Moo> type checks when used with L<Type::Tiny>.  It will
automatically apply to isa checks and coercions that use Type::Tiny.
Non-Type::Tiny isa checks will work as normal.
